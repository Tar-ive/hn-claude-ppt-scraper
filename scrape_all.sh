...
python filter_results.py --in hn_queries.json --out hn_powerpoint.json --mode llm --model z-ai/glm5 --llm-limit 20 --max-days 14 --seen-file seen_ids.json || \
  python filter_results.py --in hn_queries.json --out hn_powerpoint.json --mode regex --max-days 14 --seen-file seen_ids.json
