...
python filter_results.py --in hn_queries.json --out hn_powerpoint.json --mode llm --model z-ai/glm5 --llm-limit 20 --max-days 90 || \
  python filter_results.py --in hn_queries.json --out hn_powerpoint.json --mode regex --max-days 90
